...
from fully_connected_model import DirichletProcessVariationalAutoEncoder, compute_evidence_lower_bound
...
# init model
model = DirichletProcessVariationalAutoEncoder(X_km, T, eta, d, p, N, device).to(device)
...
torch.save(model.state_dict(), "weights/DPVAE_T25_eta5.pt")